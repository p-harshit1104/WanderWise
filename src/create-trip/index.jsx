...
const CreateTrip = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center bg-gradient-to-b from-red-300 to-gray-100 min-h-screen py-8 px-4">
      {/* Heading */}
      ...
      <div className="flex flex-col w-full max-w-2xl mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {SelectBudgetOptions.map((item, index) => (
            <div
              key={index}
              className={`rounded-xl border-2 border-transparent hover:border-blue-500 hover:bg-white transition-all duration-100 p-6 cursor-pointer ${
